...
<body>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="" novalidate>
                    ...
                    <div class="col-12">
                      <input type="hidden" name="role" class="form-control" id="role" value="author">
                    </div>
                    ...
                    <div class="col-12">
                      <a href="/" class="btn btn-secondary w-100">Go Back</a>
                    </div>
              <?php
              if($register){
  ...
  <!-- Js Files Here -->
  <?php include '../../sbp-admin/dashboard/components/importJs.php';?>
