                        ...
                        <div class="flex-grow-1 flex-shrink-1">
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="mb-1">
                                        <?php echo $row_cmnt['name']; ?> <span class="small">- <?php echo $row_cmnt['comment_date']; ?></span>
                                    </p>
                                    <a href="#!" class="link reply-link"><i class="fas fa-reply fa-xs"></i><span class="small"> reply</span></a>
                                </div>
                                <p class="small mb-0">
